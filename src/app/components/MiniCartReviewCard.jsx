                        ...
                        {review &&
                            <ul className='flex'>
                                {Array.from({ length: review }).map((_, index) => (
                                    <li key={index}> <Star size={16} className='fill-yellow-400 text-yellow-400' key={index} /></li>
                                ))}
                            </ul>
                        }

                        {totalReview && (
                            <span className="capitalize text-[#5a5a5a] text-xs">{`${totalReview} reviews`}</span>
                        )}
