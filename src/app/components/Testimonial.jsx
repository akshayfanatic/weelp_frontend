    ...
    return (
        <div className='bg-white rounded-lg p-4 flex flex-col gap-4 flex-wrap  shadow-md h-full justify-evenly'>
            ...
            <div className='flex gap-4 items-center flex-wrap'>
                ...
                <div>
                    <h3 className='text-black text-xl font-semibold flex items-center gap-2'>Oguz <BadgeCheck className='text-white fill-sky-500 text-xl' /></h3>
            ...
            <div className='flex justify-between flex-wrap'>
                ...
                <Link href={"/"} className='text-secondaryDark text-base uppercase flex items-center gap-2'>View <ArrowRight size={16} /></Link>
            </div>
        </div>
    )
}
