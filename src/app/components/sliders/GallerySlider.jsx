                    ...
                    {imageData.map((val, index) => (
                        <SwiperSlide key={index}>
                            <img
                                src={val.image}
                                alt={`Slide ${index + 1}`}
                                className="max-w-full xs:max-w-80 w-full h-[400px] object-cover rounded-xl"
                            />
                        </SwiperSlide>
                    ))}
                    ...
                    {imageData.map((val, index) => (
                        <SwiperSlide key={index}>
                            <img
                                ...
                                className="max-w-80 w-full max-h-[70px] h-full object-cover rounded-md cursor-pointer"
                            />
                        </SwiperSlide>
                    ))}
                </Swiper>
