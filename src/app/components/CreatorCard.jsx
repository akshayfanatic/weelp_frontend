    ...
    <div className="w-full max-w-full sm:max-w-sm  p-4 sm:p-6">
      ...
      <div className="px-4 flex justify-between">
        <div className="flex flex-col">
          ...
          <h3 className="text-[#142A38] text-lg font-medium">{`${
            title ? title : "4N-3D In London"
          }`}</h3>
        </div>
        <div className="flex justify-between items-center">
          <Image
            src={creatorLogo ? creatorLogo : "/assets/Card.png"}
            className="size-11 rounded-full mt-4"
            width={44}
            height={44}
            alt="creator_image"
          />
