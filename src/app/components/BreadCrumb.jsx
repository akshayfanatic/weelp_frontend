...
const BreadCrumb = ({ className }) => {
  ...
  const absoluteSlugs = pathArray.filter(
    ...
    <div className={`${className}`}>
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem
            className={
              "text-base text-[#566872] font-medium last:text-[#566872]"
            }
          >
          ...
          {absoluteSlugs.map((val, index) => {
            return (
              <React.Fragment key={index}>
                ...
                <BreadcrumbItem
                  className={
                    "capitalize text-[#566872] text-base font-medium last:font-bold last:text-[#566872]"
                  }
                >
                  {val}
                </BreadcrumbItem>
