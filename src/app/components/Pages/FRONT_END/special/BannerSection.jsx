  ...
  return (
    <section className='min-h-[60vh] h-full bg-center bg-no-repeat flex items-center justify-center' style={{ backgroundImage: `url(${bannerImage})` }}>
      <div className='w-fit flex flex-col gap-2 mb-16 scale-75 sm:scale-100'>
        ...
        <p className='text-white sm:text-lg text-center text-wrap opacity-70'>You'll discover everything from whisky to Harry Potter, <br /> or even some bodysnatchers, in Scotland's captivating capital.</p>
        <BannerSelectBox />
      </div>
    </section>
  )
