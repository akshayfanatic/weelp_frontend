...
const BannerSection = () => {
  ...
  // destructure data
    ...
    return (
      <section
        className="flex h-[60vh] page_country_banner"
        ...
        <div className="flex mx-auto w-full h-full items-center relative">
          <div className="flex flex-col flex-[1] p-6 lg:p-20 items-start self-center justify-center gap-4">
            <div className="xl:translate-x-20 flex flex-col gap-4">
              <h1 className="text-2xl sm:text-5xl  font-semibold text-Nileblue capitalize">
                {name}
              </h1>
              <p className="text-grayDark text-lg mb-8 font-medium">
                {description}
              </p>
              <BookingForm2 />
            </div>
          ...
          <Icons.Vector1
            className={"hidden xl:block absolute left-[48%] z-10 "}
          />
          <Icons.Vector2
            className={"w-48 absolute left-2 bottom-0 z-0 lg:block"}
          />
          <div
            className="hidden xl:flex flex-[1] h-full w-full  justify-start items-end bg-cover bg-no-repeat relative"
            style={{ backgroundImage: `url(${bannerImage})` }}
          >
            <div className="absolute left-[20%] top-[70%]">
              <p className="text-[#DFDFEB] text-lg w-3/5">
                This far flung region is made of icy blue waters and snow
                covered landscapes of incredible beauty.
              </p>
            </div>
          </div>
        </div>
