            ...
            <div className="flex justify-between flex-col sm:flex-row px-6">
                ...
                <div className="mt-4">
                    ...
                    >
                        ...
                        <SelectContent>
                            <SelectGroup>
                                <SelectItem
                                    className="cursor-pointer ease-in-out duration-200 capitalize focus:bg-[#f2f7f5] text-grayDark"
                                    value="Low to High"
                                >
                                    Low to High
                                </SelectItem>
                ...
                <div className="mt-4 flex">
                    <div className="flex gap-4 flex-wrap">
                        <button
                            className="relative flex items-center gap-4 text-grayDark border text-base p-2 px-6 rounded-lg"
                    ...
                    {showSort && (
                        <div
                            className="absolute top-40 sm:right-0 sm:top-10 h-fit w-fit z-10 mt-8 border bg-white rounded-md"
