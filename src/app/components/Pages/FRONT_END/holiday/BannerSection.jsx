    ...
    return (
        <section className='relative min-h-[320px] sm:min-h-[420px] h-full flex justify-center items-center bg-[#F5F9FA] p-6'>
            <div className='max-w-xl w-full flex flex-col items-center gap-2'>
                ...
                <p className='text-sm sm:text-lg font-medium text-grayDark text-center'>You&apos;ll discover everything from whisky to Harry Potter, or even some bodysnatchers, in Scotland&apos;s captivating capital.</p>
                <div className={`mt-2`} ><BookingForm /></div>
