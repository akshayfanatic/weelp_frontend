      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <fieldset className={`grid grid-cols-1 sm:grid-cols-2 gap-4 py-4 ${isSubmitting && "cursor-wait"}`} disabled={isSubmitting}>
          ...
          <div className="grid gap-3">
            ...
            <Input type="text" {...register("license_number", { required: "License Number Required" })} placeholder="Enter License Number" />
          ...
          <div className="grid gap-3">
            ...
            <Input type="date" {...register("license_expiry", { required: "Licese Expiry Requried" })} />
