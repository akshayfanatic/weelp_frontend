        ...
        <fieldset className={`grid gap-4 py-4 ${isSubmitting && "cursor-wait"}`} disabled={isSubmitting}>
          ...
          <div className="flex gap-4">
            <div className="grid gap-3 w-full">
              ...
              <Input
                type="number"
                {...register("min_distance", { required: "Min Distance Required", valueAsNumber: true })}
                id="min_distance"
                name="min_distance"
            ...
            <div className="grid gap-3 w-full">
              ...
              <Input type="number" {...register("waiting_charge", { required: "Waiting Charge Required" })} id="waiting_charge" name="waiting_charge" placeholder="Enter Waiting Charge" />
          ...
          <div className="flex gap-4">
            <div className="grid gap-3 w-full">
              ...
              <Input type="number" {...register("base_price", { required: "Base price Required", valueAsNumber: true })} id="base_price" name="base_price" placeholder="Enter Base Price" />
            ...
            <div className="grid gap-3 w-full">
              ...
              <Input type="number" {...register("price_per_km", { required: "Price Per KM Required", valueAsNumber: true })} id="price_per_km" name="price_per_km" placeholder="Enter Price Per KM" />
          ...
          <div className="flex gap-4">
            <div className="grid gap-3 w-full">
              ...
              <Input
                type="number"
                {...register("night_charge_multiplier", { required: "Night charge Required", valueAsNumber: true })}
            ...
            <div className="grid gap-3 w-full">
              ...
              <Input
                type="number"
                {...register("peak_hour_multiplier", { required: "Field Required", valueAsNumber: true })}
