      ...
      <AccordionItem value="item-1">
        ...
        <AccordionContent className="px-2 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input type="url" placeholder="Enter OG Image Url" className="focus-visible:ring-secondaryDark" {...register("seo.og_image_url", { required: "og_image_url Required" })} />
          ...
          <div className="space-y-2">
            ...
            <Input type="url" placeholder="Enter canonical URL" className="focus-visible:ring-secondaryDark" {...register("seo.canonical_url", { required: "canonical_url Required" })} />
