...
export const EditPackageForm = ({ categories, attributes, tags, locations = [], allactivities, alltransfers, itineraries, packageData }) => {
  ...
  const ScheduleTab = () => {
    ...
    const handleRemoveActivity = async (activity, packageId, day) => {
      ...
      // delete from api
      try {
        const res = await deletePackageItems({ packageId, deleted_activity_ids });
    ...
    const handleRemoveTransfer = async (transfer, packageId, day) => {
      ...
      try {
        const res = await deletePackageItems({ packageId, deleted_transfer_ids }); // send delete request
    ...
    const hanldeRemoveItinerary = async (transfer, packageId, day) => {
      ...
      try {
        const res = await deletePackageItems({ packageId, deleted_itinerary_ids }); // send delete request
