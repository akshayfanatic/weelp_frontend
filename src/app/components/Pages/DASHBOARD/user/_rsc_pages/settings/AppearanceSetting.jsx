            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription className="text-sm">
                  Set the font you want to use in dashboard
                </FormDescription>
              </FormItem>
            )}
          />
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    <FormItem
                      className={`p-4 cursor-pointer border-2 flex items-center gap-2 rounded-md ${
                        selectedTheme === "light"
                          ? "border-secondaryDark bg-secondaryLight2"
                          : ""
                      }`}
                    >
                      <FormControl>
                ...
                <FormMessage />
                <FormDescription className="text-sm">
                  Select the theme for dashboard
                </FormDescription>
              </FormItem>
            )}
          />
