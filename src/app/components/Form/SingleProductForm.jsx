...
export default function SingleProductForm({ productId }) {
  ...
  const onSubmit = async (data) => {
    const { setFormData } = useProductFormStore.getState(); // Get Zustand action
    setFormData(data);
          ...
          <div className=" w-full flex flex-col gap-4">
              ...
              <div className="flex flex-col items-center border-x border-r-0 w-full  justify-center">
                <div className="p-2 sm:p-4">
                  ...
                  >
                    ...
                    {formData?.howMany?.adults !== undefined ? (
                      <span>
                        Adults {formData?.howMany?.adults}{" "}
                        {formData?.howMany?.children > 0 ? (
                          <span>Teen {formData?.howMany?.children}</span>
                        ) : (
                          ""
                        )}
                      </span>
            ...
            <div className="flex rounded-lg absolute z-50 pointer-events-auto  top-[30%] w-full scale-90 sm:scale-[unset]">
              ...
              {showResponse && formData && Object.keys(formData).length > 0 ? (
                <div className="bg-white text-nowrap flex flex-col gap-4  w-full items-center border shadow-lg rounded-xl">
