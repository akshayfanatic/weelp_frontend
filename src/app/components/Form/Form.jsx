        ...
        <div className="p-4 sm:p-6 px-6 sm:px-0  mx-auto md:w-[560px] w-full relative bannerForm">
            ...
            >
                <div className="flex border-y-[1px]  shadow-sm border w-full bg-white rounded-l-xl rounded-r-xl">
                    ...
                    <div className="flex flex-col items-center border-x border-l-0 w-full  justify-center">
                        <div className="p-2 sm:p-4">
                            ...
                            {errors.whereTo && (
                                <p className="text-red-500 text-sm text-center">{errors.whereTo.message}</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center border-x border-l-0 w-full  justify-center">
                        <div className="p-2 sm:p-4">
                            ...
                            {errors.dateRange && (
                                <p className="text-red-500 text-sm text-center">{errors.dateRange.message}</p>
                            )}
                        </div>
                    </div>
                ...
                <div className="flex rounded-lg absolute z-50 pointer-events-auto top-3/4 translate-y-4 w-full scale-90 sm:scale-[unset]">
                    {showLocation && (
                        <div onMouseLeave={e => { e.stopPropagation(), setShowLocation(!showLocation) }} className="flex w-full justify-center sm:justify-start">
                    ...
                    {showCalendar && (
                        <div onMouseLeave={e => { e.stopPropagation(), setShowCalendar(!showCalendar) }}
                    ...
                    {showHowMany && (
                        <div onMouseLeave={e => { e.stopPropagation(), setShowHowMany(!showHowMany) }}
