        ...
        <div className="w-full sm:w-[520px] rounded-2xl relative shadow-sm bannerForm ">
            ...
            >
                ...
                <div className="flex border rounded-2xl bg-white overflow-hidden">
                    {/* Where To */}
                    <div
                        className="flex-1 border-r cursor-pointer p-4"
                        onClick={() => toggleSection("whereTo")}
                    >
                ...
                <div className="flex rounded-lg absolute z-[30] pointer-events-auto top-3/4  translate-y-8 w-fit scale-90 sm:scale-[unset]">
                    {activeSection === "whereTo" && (
                        <div onMouseLeave={(e) => { e.stopPropagation(), setActiveSection("") }}
                    ...
                    {activeSection === "when" && (
                        <div onMouseLeave={(e) => { e.stopPropagation(), setActiveSection("") }} className="flex w-full justify-start sm:justify-start flex-col -translate-x-8 sm:-translate-x-0  bg-gray-50 p-4 rounded-lg ">
                            <Controller
                                name="dateRange"
                                control={control}
                            ...
                            <button
                                type="submit"
                                className="w-fit py-2 px-8 bg-secondaryDark text-white rounded-md shadow"
                            >
                                Submit
                            </button>
                        </div>
