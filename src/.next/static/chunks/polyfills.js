!(function () {
    ...
    Fo = {
      getConstructor: function (t, e, r, n) {
        var o = t(function (t, o) {
            (ko(t, i), Co(t, { type: e, index: Ve(null), first: null, last: null, size: 0 }), u || (t.size = 0), P(o) || Ao(o, t[n], { that: t, AS_ENTRIES: r }));
          }),
          i = o.prototype,
          a = _o(e),
          s = function (t, e, r) {
  ...
  (Ce({ target: 'Map', proto: !0, real: !0, forced: !0 }, { upsert: Ii }), Ce({ target: 'Map', proto: !0, real: !0, name: 'upsert', forced: !0 }, { updateOrInsert: Ii }));
  var Ti = b((1).valueOf),
    Mi = '\t\n\v\f\r                　\u2028\u2029\ufeff',
    Li = b(''.replace),
    Ui = RegExp('^[' + Mi + ']+'),
  ...
  var yl = { f: dt },
    ...
    $l = function (t, e, r) {
      ...
      return (
        kt(r),
        ut(Fl, n)
          ? (r.enumerable ? (ut(t, El) && t[El][n] && (t[El][n] = !1), (r = Ve(r, { enumerable: d(0, !1) }))) : (ut(t, El) || Ul(t, El, d(1, Ve(null))), (t[El][n] = !0)), ql(t, n, r))
          : Ul(t, n, r)
      );
    },
    Kl = function (t, e) {
  ...
  wv.prototype = {
    ...
    parseQuery: function (t) {
      if (t) for (var e, r, n = this.entries, o = av(t, '&'), i = 0; i < o.length; ) (e = o[i++]).length && ((r = av(e, '=')), rv(n, { key: vv(ov(r)), value: vv(ev(r, '=')) }));
    },
    serialize: function () {
  ...
  xg.prototype = {
    ...
    serialize: function () {
      var t = this,
        ...
        c = e + ':';
      return (
        null !== o ? ((c += '//'), t.includesCredentials() && (c += r + (n ? ':' + n : '') + '@'), (c += Gd(o)), null !== i && (c += ':' + i)) : 'file' === e && (c += '//'),
